...
export const ministryData: MinistryItem[] = [
  {
    ...
    title: '전도제자화 훈련(6주간)',
    category: 'church',
    coreMessage: '평신도를 교회의 주체적인 리더로 세우는 전도 및 제자화 훈련.',
    description: '전도와 제자화를 실제 현장에서 실행할 수 있도록 훈련하며 제주 교회 안에 전도, 양육, 연합의 흐름을 세우는 6주 집중 과정입니다.',
    details: [
      '목적: 평신도를 주체적 리더로 세우고, 실제 현장 전도 및 양육 흐름 구축',
      '진행 방식: 예배, 찬양, 전도실습, 양육, 나눔이 통합된 현장 중심 훈련',
    ...
    subItems: [
      {
        ...
        tagline: '전도를 위한 워밍업',
        description: 'THE FOUR 전도 훈련 1, 2를 통해 4가지 심볼과 핵심 키워드를 익힙니다.'
      },
      {
        title: '2주차: 하나님의 사랑과 용서',
        tagline: '강의 1 & 전도실천 1',
        description: '하나님의 사랑과 용서를 체험하고 첫 번째 현장 전도실천을 진행합니다.'
      },
      {
        title: '3주차: 성령충만한 삶',
        tagline: '강의 2 & 전도실천 2',
        description: '성령충만한 삶으로 살아가는 법을 배우고 두 번째 전도실천을 진행합니다.'
      },
      {
        title: '4주차: 예수님의 목표와 제자화',
        tagline: '강의 3 & 전도실천 3',
        description: '예수님의 목표와 제자화 사역 원리를 배우고 세 번째 전도실천을 진행합니다.'
      },
      {
        title: '5주차: 양육 과정 전환',
        tagline: '강의 4 & 새생활의 시작 1-2',
        description: '양육 중심 과정으로 전환하여 <새생활의 시작> 시리즈를 통한 양육을 진행합니다.'
      },
      {
        title: '6주차: 양육 심화 및 마무리',
        tagline: '새생활의 시작 3-4 & 나눔',
        description: '<새생활의 시작> 3-4권 중심 양육 심화 및 나눔과 간증으로 마무리합니다.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    description: '1993년부터 시작된 P2C 협력 사역으로, 결혼 예비 학교부터 노년기까지 전 생애 주기에 걸쳐 가정을 강화하는 사역입니다.',
    details: [
  ...
  },
  {
    ...
    title: '평신도 리더십 훈련',
    category: 'workplace',
    coreMessage: '일터위에 복음의 선한 영향력을 세우기 위한 리더십 강화 훈련',
    description: '일터위에 복음의 선한 영향력을 세우기 위한 리더십을 기르기 위한 훈련입니다.',
    details: [
      '단계별 제자훈련',
      '멘토링 세미나',
      '일터 컨퍼런스',
...
export const categories: Category[] = [
  { 
    ...
    fullDescription: '1. 목회자/사모 리빌딩 운동\n목회자 부부 영성 회복 및 작은 교회 돕기\n\n2. 다음 세대를 향한 전략적 선교\n진로 코칭세미나, P2P 부모/자녀 1박2일 캠프, 겨울 청소년 금식수련회\n\n3. 평신도 리더십 세우기\n일터 사역(비즈니스 스쿨), 평신도 전도 제자화훈련(6주간)' 
  },
  { 
    id: 'family', 
    title: '가정', 
